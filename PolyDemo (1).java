    ...
    public class PolyDemoPanel extends JPanel {
        ...
        public Shape getRandShape() {
            ...
            switch ((int) (Math.random() * 4)) {
                case 0:
                    retVal = new FractalFlake(x, y, x, y, x*y); // new Square(x, y, getRandInt(), getRandInt());
                    break;
                case 1:
                    retVal = new FractalFlake(x, y, x, y, x*y); //new Spray(x, y);  Cube(x, y, getRandInt(), getRandInt(), getRandInt());
                    break;
                case 2:
                    retVal = new FractalFlake(x, y, x, y, x*y); //new Spray(x, y);
                    break;
                case 3:
                    retVal = new FractalFlake(x, y, x, y, x*y); //new Spray(x, y); // new Circle(x, y, getRandInt()); // new Cylinder(x, y, getRandInt(), getRandInt());
                    break;
            }
